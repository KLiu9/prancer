...
LABELS_FILE = "./clinical-annotator-lookups/newumls.pk"  # Map keyword -> UMLS code
INDEX_FILE = "./clinical-annotator-lookups/index_snomed.pk"  # Map UMLS code -> index
TYPES_FILE = "./clinical-annotator-lookups/newtypes.pk"  # Map types and tuis
COLORS_FILE = "./clinical-annotator-lookups/newcolors.pk"  # Map type -> color
SUGGESTIONS_FILE = "./clinical-annotator-lookups/suggestions.pk"  # Map word -> CUI
